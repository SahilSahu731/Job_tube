...
const Footer = () => {
  return (
    <footer className="border-t w-full opacity-60 bg-gray-700 text-center py-4 px-4">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl text-left font-bold">Job Tube</h2>
            <p className="text-sm">© 2024 Job Tube. All rights reserved.</p>
          </div>
