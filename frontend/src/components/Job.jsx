...
const Job = ({job}) => {
    ...
    return (
        <div className='p-5 rounded-md shadow-xl bg-gray-600  border border-gray-100'>
            <div className='flex items-center justify-between'>
                ...
                <Button variant="outline" className="rounded-full bg-inherit hover:scale-110 transition-all duration-500 hover:bg-green-500 hover:border-none" size="icon"><Bookmark /></Button>
            </div>
